...
export class CurriculumVersionCreated extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; versionNo: string; name: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class CurriculumVersionSuperseded extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; supersededByVersionId: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class CurriculumPublished extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; publishedBy: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class ProgrammeCreated extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    payload: { code: string; name: string; examProductId: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class ProgrammeVersionCreated extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; versionNo: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class CourseAdded extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; courseId: string; name: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class SubjectAdded extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; courseId: string; subjectId: string; name: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class ModuleAdded extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; subjectId: string; moduleId: string; name: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class LearningObjectiveAdded extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; competencyId: string; objectiveId: string; code: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
...
export class LearningOutcomeAdded extends BaseCurriculumEvent {
  constructor(
    aggregateId: string,
    aggregateVersion: number,
    payload: { versionId: string; objectiveId: string; outcomeId: string; code: string },
    correlationId?: string,
    causationId?: string,
    actorId?: string
  ) {
