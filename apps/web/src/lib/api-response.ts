...
export const ApiResponse = {
   ...
   */
  success<T>(data: T, options?: { requestId?: string; status?: number; meta?: Partial<ApiMeta> }): NextResponse {
  ...
  forbidden(requestId?: string): NextResponse {
    return ApiResponse.error('FORBIDDEN', 'You do not have permission to perform this action.', 403, { requestId });
  },
