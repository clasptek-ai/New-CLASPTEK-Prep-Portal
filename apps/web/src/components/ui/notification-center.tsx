...
export type NotificationCategory =
  'ANNOUNCEMENT' | 'AI_EVENT' | 'ASSESSMENT' | 'REMINDER' | 'INTERVENTION' | 'SYSTEM_ALERT';
...
export function NotificationCenter({
  ...
  return (
    <Card
      title="Workspace Notification Center"
      actions={
            ...
            filtered.map((n) => (
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  >
                    <Badge variant={n.category === 'INTERVENTION' ? 'danger' : 'info'}>
                      {n.category}
                    </Badge>
                    <span
                      style={{
