...
export const instructorNavigation: InstructorNavigationItem[] = [
  ...
  { name: 'Cohort Management', href: '/instructor/cohorts', icon: 'FolderGit', requiredPermission: 'MANAGE_COHORTS' },
  { name: 'Assessment Library', href: '/instructor/assessments', icon: 'BookOpen', requiredPermission: 'MANAGE_ASSESSMENTS' },
  { name: 'AI Evaluations', href: '/instructor/evaluation', icon: 'FileCheck', requiredPermission: 'OVERRIDE_AI_SCORES' },
  ...
  { name: 'Analytics Workspace', href: '/instructor/analytics', icon: 'LineChart', requiredPermission: 'VIEW_ANALYTICS' },
  ...
  { name: 'Generated Reports', href: '/instructor/reports', icon: 'FileBarChart', requiredPermission: 'EXPORT_REPORTS' },
