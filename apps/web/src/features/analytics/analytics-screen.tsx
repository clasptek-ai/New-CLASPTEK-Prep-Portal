...
export function AnalyticsScreen() {
  ...
  const progressData = [60, 65, 75, 78, 84.50];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div>
        ...
        <p style={{ margin: 0, fontSize: '0.85rem', color: '#94a3b8' }}>Statistical dashboards of student readiness, mastery, and study timelines</p>
      </div>
