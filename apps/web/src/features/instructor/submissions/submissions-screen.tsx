...
import {
  ...
  Submission,
} from '../../../services/instructor/submissions.service';
      ...
      setSubmissions((prev) =>
        prev.map((s) =>
          s.id === selectedSubmission.id
            ? { ...s, status: 'GRADED', instructorGrade: grade, instructorFeedback: feedback }
            : s
        )
      );
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        <div>
          ...
          <p style={{ margin: 0, fontSize: '0.85rem', color: '#94a3b8' }}>
            Review, grade, and inspect automated AI essay diagnostics results
          </p>
        </div>
              ...
              {selectedSubmission.aiEvaluation && (
                ...
                >
                  ...
                  <div>
                    ...
                    <strong>{selectedSubmission.aiEvaluation.predictedBand}</strong>
                  </div>
                  <div>
                    Grammar Score: <strong>{selectedSubmission.aiEvaluation.grammarScore}%</strong>
                  </div>
                  <div>
                    Coherence Score:{' '}
                    <strong>{selectedSubmission.aiEvaluation.coherenceScore}%</strong>
                  </div>
