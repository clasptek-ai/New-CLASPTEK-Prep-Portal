        ...
        >
          <div>
            <h1 style={{ margin: 0, fontSize: '1.75rem', fontWeight: 800 }}>
              Welcome to the Instructor Workspace
            </h1>
            <p style={{ margin: '0.5rem 0 0 0', color: '#94a3b8' }}>
              Facilitate student learning paths, verify readiness metrics, and review assignments
              submissions.
            </p>
          </div>
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <Button variant="secondary" onClick={() => router.push('/instructor/resources')}>
              Upload Resource
            </Button>
          </div>
        </div>
