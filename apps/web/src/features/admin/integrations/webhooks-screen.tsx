...
import {
  adminWebhookService,
  WebhookDeliveryLog,
} from '../../../services/admin/integrations/webhook.service';
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p style={{ margin: 0, fontSize: '0.85rem', color: '#94a3b8' }}>
            Inspect payloads, retry failed messages, and replay events manually
          </p>
        </div>
          ...
          >
            ...
            >
              <div style={{ color: '#cbd5e1' }}>
                ...
                <p style={{ margin: 0 }}>
                  Response Code: **{log.responseStatus}** | Timestamp: {log.timestamp}
                </p>
              </div>
              <Button onClick={() => handleReplay(log.id)}>Replay Event</Button>
            </div>
          </Card>
        ))}
      </div>
