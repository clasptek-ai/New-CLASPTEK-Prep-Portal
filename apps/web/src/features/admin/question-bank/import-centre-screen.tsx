    ...
    <PageContainer>
      <PageContent>
        ...
        >
            ...
            <div style={{ position: 'relative' }}>
              ...
              {templateMenuOpen && (
                ...
                >
                  ...
                  >
                    <Code2 size={15} color="var(--brand-primary)" /> Universal Template (JSON)
                  </button>
                  <button
                    onClick={() => {
                    ...
                    onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = 'transparent')}
                  >
                    <FileText size={15} color="var(--success)" /> Universal Template (CSV)
                  </button>
                </div>
              )}
            </div>
                    ...
                    return (
                      <label
                        ...
                        style={{
                          ...
                          borderRadius: '8px',
                          border: '1px solid',
                          borderColor: isChecked ? 'var(--brand-primary)' : 'var(--border)',
                          cursor: 'pointer',
                        }}
                      >
                        <input
          ...
          {/* Import Package Mode Cards (Universal JSON, Universal CSV, Rich ZIP, Folder Tree) */}
          <div
            style={{
              display: 'grid',
          ...
          >
            {[
              {
                id: 'JSON',
                label: 'Universal JSON Package',
                sub: 'Standard Schema with hierarchical nodes',
                icon: <Code2 size={20} color="#38bdf8" />,
              },
              {
                id: 'CSV',
                label: 'Universal Flat CSV',
                sub: 'Standard Row Format with delimiter tags',
                icon: <FileSpreadsheet size={20} color="#34d399" />,
              },
              {
                id: 'ZIP',
                label: 'Rich ZIP Bundle',
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '14px',
                  backgroundColor:
                    activeFormat === fmt.id ? 'rgba(56, 189, 248, 0.12)' : 'var(--surface-0)',
                  border:
                    activeFormat === fmt.id
              ...
              >
                ...
                <div>
                  <div
                    style={{ fontSize: '0.95rem', fontWeight: 800, color: 'var(--text-primary)' }}
                  >
                    {fmt.label}
                  </div>
                  <div
          ...
          >
            <div style={{ fontSize: '1.05rem', fontWeight: 800, color: 'var(--text-primary)' }}>
              Batch File Upload & Schema Validation ({activeFormat}) — [{selectedProgramme} /
            ...
            <div
              ...
              style={{
                padding: '3.5rem 2rem',
                borderRadius: '14px',
                backgroundColor: isDragging ? 'var(--surface-hover)' : 'var(--surface-1)',
                border: isDragging ? '2px dashed var(--brand-primary)' : '2px dashed var(--border)',
                textAlign: 'center',
                display: 'flex',
                flexDirection: 'column',
                alignItems: 'center',
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: '0.25rem' }}
                >
                  Accepted:{' '}
                  ...
                  | Target Exam:{' '}
                  <strong style={{ color: 'var(--text-primary)' }}>{selectedProgramme}</strong>
                </div>
              </div>
              ...
              >
                <FileText size={16} />
                <span>
                  {isSimulating ? 'Validating Batch Schema...' : 'Browse PC & Select File'}
                </span>
              </Button>
            </div>
            ...
            {importResult && (
              ...
              >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: '0.8rem', color: '#cbd5e1', marginTop: '2px' }}>
                        ...
                        <strong style={{ color: '#fff' }}>{selectedProgramme}</strong> | JSON Exam
                        Type:{' '}
                ...
                >
                  ...
                  >
                    <CheckCircle2 size={16} /> Import Valid Questions ({importResult.validQuestions}
                    ) to Question Bank
                  </Button>
