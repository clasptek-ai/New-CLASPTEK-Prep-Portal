    ...
    sections: [
      {
        id: 'sec-ielts-ls',
        name: 'Listening',
        questionTypes: ['MCQ', 'FILL_IN_BLANK', 'MATCHING'],
        questionCount: 40,
        timeLimitMinutes: 30,
        passingScorePercent: 60,
        difficultyDistribution: { EASY: 25, MEDIUM: 50, HARD: 25 },
        instructions: 'Listen to 4 audio recordings and answer 40 questions in 30 minutes.',
      },
      {
        id: 'sec-ielts-rd',
        name: 'Reading',
      ...
      },
      {
        ...
        passingScorePercent: 60,
        difficultyDistribution: { EASY: 0, MEDIUM: 50, HARD: 50 },
        instructions: 'Complete Part 1 (Introduction), Part 2 (Cue Card), and Part 3 (Discussion).',
      },
    ],
  },
  {
