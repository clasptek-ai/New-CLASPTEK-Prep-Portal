  ...
  const logs = [
    {
      ...
      user: 'Jane Doe',
      assetType: 'QUESTION',
      action: 'Created draft question Modifiers',
    ...
    },
    {
      ...
      user: 'Bob Smith',
      assetType: 'PROGRAMME',
      action: 'Modified outcome tags for Grammar Intensive',
      timestamp: '2026-07-15',
    },
    {
      id: '3',
      user: 'System',
      assetType: 'PUBLISHING',
      action: 'Released English Placement Exam Module A',
      ...
      >
        <div>
          ...
          <p style={{ margin: 0, fontSize: '0.85rem', color: '#94a3b8' }}>
            Governance audits tracking author edits and publication histories
          </p>
        </div>
