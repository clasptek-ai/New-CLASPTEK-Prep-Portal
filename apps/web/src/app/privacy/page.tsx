    ...
    <>
      ...
      >
        ...
        <Card title="1. Information We Collect">
          <p style={{ margin: 0, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            We collect personal details (e.g. name, email, credentials) when you register on our
            portal, alongside diagnostic performance records, response answers inputs, mock exam
            timings, and browser tab active states to validate academic integrity.
          </p>
        </Card>

        <Card title="2. How We Use Information">
          <p style={{ margin: 0, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            Your information is processed to calculate learning readiness metrics, dispatch
            notifications, offer customized study recommendations, and enable automated assessment
            evaluations.
          </p>
        </Card>
        ...
        <Card title="3. Cookies & Tracking">
          <p style={{ margin: 0, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            We use secure cookies and local storage tokens to manage auth sessions and cache
            preference configurations dynamically.
          </p>
        </Card>
      </main>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem' }}>
          <Link href="/privacy" style={{ color: 'var(--text-muted)', fontWeight: 600 }}>
            Privacy Policy
          </Link>
