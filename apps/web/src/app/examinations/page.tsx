          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-bold transition-all cursor-pointer ${
              activeCategory === 'all'
                ...
                : 'bg-white text-slate-700 border border-slate-300 hover:bg-bg-neutral'
            }`}
          >
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-4">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="text-[11px] font-semibold text-slate-700 bg-bg-neutral border border-slate-200 px-2 py-0.5 rounded">
                    {track.badge}
                  </span>
              ...
              <div className="lg:w-80 shrink-0 flex flex-col justify-between p-5 rounded-xl bg-bg-neutral border border-slate-200 gap-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-xs pb-2 border-b border-slate-200">
                    <span className="text-slate-600 uppercase font-bold">Total Duration</span>
                    <span className="font-bold text-deep-navy">{track.durationMinutes} Minutes</span>
                  </div>

                  <div className="flex justify-between items-center text-xs pb-2 border-b border-slate-200">
                    <span className="text-slate-600 uppercase font-bold">Questions</span>
                    <span className="font-bold text-deep-navy">{track.totalQuestions}</span>
                  </div>

                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-600 uppercase font-bold">Target Benchmark</span>
