  ...
  return (
    <PageContainer>
      ...
      <PageHeader
        ...
        description="Live candidate database — audit registrations, target exam assignments, and access gates."
        actions={
          <Button
            variant="primary"
                              ...
                              >
                                ...
                                <button
                                  ...
                                  style={{
                                    ...
                                    backgroundColor: 'transparent',
                                    color:
                                      s.status === 'ACTIVE' ? 'var(--danger)' : 'var(--success)',
                                    cursor: 'pointer',
                                    fontSize: '0.8rem',
                                    fontWeight: 600,
            ...
            >
              <div>
                ...
                >
                  ...
                  student records for{' '}
                  <strong style={{ color: 'var(--text-primary)' }}>{deletingStudent.name}</strong>.
                </p>
              </div>
