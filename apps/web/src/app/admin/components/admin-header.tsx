...
const SEARCH_DESTINATIONS: SearchResult[] = [
  // Overview
  {
    id: 'dashboard',
    label: 'Dashboard',
    description: 'Admin overview, institutional telemetry & intelligence centre',
  ...
  // Learning
  {
    id: 'assessments',
    label: 'Assessments',
    description: 'Diagnostics, official mocks, and timed exam configurations',
  ...
  },
  {
    id: 'qbank',
    label: 'Question Bank',
    description: 'Question authoring, item pools, and marking rubrics',
  ...
  },
  {
    id: 'programmes',
    label: 'Programmes',
    description: 'Exam preparation tracks and curriculum structures',
  ...
  },
  {
    id: 'curriculum',
    label: 'Curriculum',
    description: 'Course and syllabus module management',
  ...
  },
  {
    ...
    description: 'Adaptive drill sets and student practice telemetry',
  ...
  },
  {
    id: 'builders',
    label: 'Builders',
    description: 'Interactive blueprint authoring engines for exams and drills',
    href: '/admin/builders',
    category: 'Learning',
  },
  // People
  {
    id: 'users',
    label: 'Users',
    description: 'Unified candidate, student, instructor, and administrator directory',
    href: '/admin/users',
    category: 'People',
  },
  // Operations
  {
    ...
    description: 'Audit student exam attempts, logs, timelines, and recordings',
    href: '/admin/attempt-review',
    category: 'Operations',
  },
  {
    id: 'assessment-reviews',
    label: 'Assessment Reviews',
    description: 'Moderator grading workflows and evaluation queues',
    href: '/admin/assessment-reviews',
    category: 'Operations',
  },
  {
    id: 'notifs',
    label: 'Notifications',
    description: 'Platform broadcast and operational alert configuration',
  ...
  },
  {
    id: 'observability',
    label: 'Observability',
    description: 'System health, error monitoring, and service telemetry',
  ...
  },
  {
    id: 'audit',
    label: 'Audit',
    description: 'Security logs and administrative event history',
    href: '/admin/audit',
    category: 'System',
  },
  {
    id: 'settings',
    label: 'Settings',
    description: 'Global system configuration and operational policies',
    href: '/admin/settings',
    category: 'System',
  },
];
