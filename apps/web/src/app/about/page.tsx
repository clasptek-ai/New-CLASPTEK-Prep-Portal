    ...
    <>
      <header className="shell-header" style={{ backgroundColor: 'var(--nav-bg)' }}>
        ...
        <nav className="shell-nav" style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
          <Link href="/about" style={{ color: 'var(--text-main)', fontWeight: 600 }}>
            About
          </Link>
      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', margin: 0 }}>
            Empowering global candidates with adaptive learning technology and AI-driven
            assessments.
          </p>
        </div>
        ...
        <Card title="Our Vision & Mission">
          <p style={{ lineHeight: 1.7, margin: 0, color: 'var(--text-muted)' }}>
            Clasptek is a pioneer in global academic preparation and assessment solutions. Our
            mission is to bridge the gap between candidate aspirations and academic/professional
            validation. Through personalized AI-powered training, predictive exam readiness, and
            real-time coaching diagnostics, we deliver a standardized pathway to international
            excellence.
          </p>
        </Card>
          ...
          >
            <Card title="Technology & Innovation">
              <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0 }}>
                Focusing on modern architectures, cloud engineering, and dynamic software
                development validation.
              </p>
            </Card>
            <Card title="Business & Management">
              <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0 }}>
                Empowering candidates with strategic analytics, execution frameworks, and operation
                credentials.
              </p>
            </Card>
            <Card title="Career Development">
              <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0 }}>
                Interview masterclasses, personal branding, resume diagnostics, and professional
                placement training.
              </p>
            </Card>
            <Card title="Global Exam Preparation">
              <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', margin: 0 }}>
                Authoritative mock tests and adaptive study pathways for IELTS, TOEFL, SAT, and
                CELPIP exams.
              </p>
            </Card>
          </div>
