    ...
    <>
      ...
      >
        ...
        <Card title="1. Agreement to Terms">
          <p style={{ margin: 0, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            By registering, logging in, or launching mock assessments, you agree to comply with
            Clasptek Global code of conduct guidelines and academic honesty covenants.
          </p>
        </Card>

        <Card title="2. Account Responsibilities">
          <p style={{ margin: 0, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            You are responsible for keeping your login credentials confidential. Multi-device
            account sharing is prohibited and will trigger automated suspension rules.
          </p>
        </Card>

        <Card title="3. Academic Integrity Covenants">
          <p style={{ margin: 0, color: 'var(--text-muted)', lineHeight: 1.6 }}>
            Attempts to bypass testing restrictions (e.g. browser resizing, blur blurs, IP address
            switching) are logged. Administrators reserve rights to flag assessments and block
            outcomes.
          </p>
        </Card>
      </main>
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem' }}>
          ...
          <Link href="/terms" style={{ color: 'var(--text-muted)', fontWeight: 600 }}>
            Terms of Service
          </Link>
        </div>
      </footer>
