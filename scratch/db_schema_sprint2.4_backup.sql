-- Clasptek Sprint 2.4 Legacy Database Schema Backup

CREATE TABLE curriculum_read.curriculum_coverage_projection (
  id uuid NOT NULL,
  curriculum_version_id uuid NOT NULL,
  exam_product_id uuid NOT NULL,
  official_exam_component_ids ARRAY NOT NULL,
  assessment_blueprint_ids ARRAY NOT NULL,
  mapped_skills_count integer NOT NULL,
  unmapped_skills_count integer NOT NULL,
  coverage_percentage numeric NOT NULL);

CREATE TABLE curriculum_read.curriculum_graph_projection (
  curriculum_version_id uuid NOT NULL,
  graph_nodes_json jsonb NOT NULL,
  graph_edges_json jsonb NOT NULL,
  has_cycles boolean NOT NULL,
  critical_path_lessons ARRAY NOT NULL);

CREATE TABLE curriculum_read.curriculum_publication_readiness_projection (
  curriculum_version_id uuid NOT NULL,
  has_exam_product_mapped boolean NOT NULL,
  has_blueprint_mapped boolean NOT NULL,
  has_skills_mapped boolean NOT NULL,
  all_modules_sequenced boolean NOT NULL,
  all_lessons_sequenced boolean NOT NULL,
  no_circular_dependencies boolean NOT NULL,
  all_outcomes_measurable boolean NOT NULL,
  all_required_locales_approved boolean NOT NULL,
  is_ready boolean NOT NULL,
  validation_messages_json jsonb NOT NULL);
...
CREATE TABLE curriculum_read.curriculum_summary_projection (
  ...
  current_version_no character varying(50) NULL,
  total_modules integer NOT NULL,
  total_lessons integer NOT NULL,
  total_estimated_study_minutes integer NOT NULL,
  default_locale character varying(15) NOT NULL,
  available_locales ARRAY NOT NULL,
...
CREATE TABLE curriculum_read.lesson_tree_projection (
  ...
  tree_structure_json jsonb NOT NULL);
...
CREATE TABLE public.activity_types (
  ...
  default_evidence_type_id uuid NULL,
  supports_interaction boolean NOT NULL,
  supports_collaboration boolean NOT NULL,
  supports_external_resource boolean NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.collection_access_grants (
  id uuid NOT NULL,
  collection_access_policy_id uuid NOT NULL,
  grantee_type character varying(50) NOT NULL,
  grantee_id character varying(255) NOT NULL,
...
CREATE TABLE public.collection_access_policies (
  ...
  sensitivity character varying(50) NOT NULL,
  required_role character varying(100) NULL,
...
CREATE TABLE public.curriculum_dependency_locks (
  ...
  locked_version_no character varying(50) NOT NULL,
...
CREATE TABLE public.curriculum_learning_path_node_map (
  id uuid NOT NULL,
  curriculum_version_id uuid NOT NULL,
  learning_path_node_id uuid NOT NULL,
  mapping_type character varying(50) NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
...
CREATE TABLE public.curriculum_locales (
  ...
  is_required_for_publication boolean NOT NULL,
  translation_status character varying(50) NOT NULL,
  display_order integer NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
...
CREATE TABLE public.curriculum_skill_map (
  ...
  skill_level_id uuid NULL,
  mapping_type character varying(50) NOT NULL,
  target_mastery_percentage numeric NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.curriculum_template_translations (
  ...
  language_code character varying(15) NOT NULL,
  localized_name_or_title character varying(255) NOT NULL,
  localized_description text NULL,
  source_language_code character varying(15) NOT NULL,
  translation_status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.curriculum_template_usage (
  ...
  instantiated_curriculum_id uuid NOT NULL,
  instantiated_at timestamp with time zone NOT NULL,
  instantiated_by uuid NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
  created_by uuid NULL,
...
CREATE TABLE public.curriculum_template_versions (
  ...
  status character varying(50) NOT NULL,
  version_no_concurrency integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
  created_by uuid NULL,
  updated_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.curriculum_version_translations (
  ...
  localized_description text NULL,
  localized_instructions text NULL,
  source_language_code character varying(15) NOT NULL,
...
CREATE TABLE public.external_link_checks (
  id uuid NOT NULL,
  external_resource_location_id uuid NOT NULL,
  http_status_code integer NULL,
  response_time_ms integer NULL,
  redirects_followed_json jsonb NOT NULL,
...
CREATE TABLE public.external_resource_locations (
  ...
  canonical_url character varying(500) NOT NULL,
  display_url character varying(500) NULL,
  provider_name character varying(100) NULL,
  provider_resource_id character varying(255) NULL,
  allowed_domains_policy jsonb NOT NULL,
  open_in_new_window boolean NOT NULL,
  requires_authentication boolean NOT NULL,
  last_validated_at timestamp with time zone NULL,
  last_http_status integer NULL,
  last_content_type character varying(255) NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.learning_activities (
  ...
  cognitive_level_id uuid NULL,
  is_required boolean NOT NULL,
  completion_definition_json jsonb NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.learning_activity_outcomes (
  ...
  mapping_type character varying(50) NOT NULL,
  importance_weight numeric NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.learning_assignments (
  ...
  submission_mode character varying(50) NOT NULL,
  evidence_type_id uuid NULL,
  difficulty_level_id uuid NULL,
  cognitive_level_id uuid NULL,
  estimated_completion_minutes integer NOT NULL,
  recommended_rubric_reference character varying(255) NULL,
  is_required boolean NOT NULL,
  allow_collaboration boolean NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.learning_modules (
  ...
  default_sequence_no integer NOT NULL,
  estimated_study_minutes integer NOT NULL,
  minimum_study_minutes integer NOT NULL,
  maximum_study_minutes integer NOT NULL,
  is_required boolean NOT NULL,
  completion_policy character varying(50) NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.learning_outcomes (
  ...
  difficulty_level_id uuid NULL,
  evidence_type_id uuid NULL,
  minimum_mastery_percentage numeric NOT NULL,
  estimated_evidence_minutes integer NOT NULL,
...
CREATE TABLE public.learning_resources (
  ...
  canonical_title character varying(255) NOT NULL,
  ...
  default_language_code character varying(15) NOT NULL,
  current_default_variant_id uuid NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.lesson_prerequisites (
  ...
  prerequisite_type character varying(50) NOT NULL,
  minimum_completion_percentage numeric NOT NULL,
  minimum_mastery_percentage numeric NOT NULL,
  required_skill_revision_id uuid NULL,
  required_skill_level_id uuid NULL,
...
CREATE TABLE public.lesson_resources (
  ...
  sequence_no integer NOT NULL,
  is_required boolean NOT NULL,
  availability_policy character varying(50) NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.lessons (
  ...
  minimum_study_minutes integer NOT NULL,
  maximum_study_minutes integer NOT NULL,
  instructional_method character varying(100) NOT NULL,
  completion_policy character varying(50) NOT NULL,
  is_required boolean NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
...
CREATE TABLE public.resource_access_grants (
  id uuid NOT NULL,
  resource_access_policy_id uuid NOT NULL,
  grantee_type character varying(50) NOT NULL,
  grantee_id character varying(255) NOT NULL,
  permission_level character varying(50) NOT NULL,
  status character varying(50) NOT NULL,
...
CREATE TABLE public.resource_checksums (
  ...
  checksum_value character varying(255) NOT NULL,
  is_primary boolean NOT NULL,
  verified_at timestamp with time zone NOT NULL,
  verification_source character varying(100) NOT NULL,
  status character varying(50) NOT NULL);
...
CREATE TABLE public.resource_formats (
  ...
  code character varying(100) NOT NULL,
  name character varying(255) NOT NULL,
  format_family character varying(100) NOT NULL,
  canonical_mime_type character varying(255) NOT NULL,
  allowed_extensions_json jsonb NOT NULL,
  supports_preview boolean NOT NULL,
  supports_streaming boolean NOT NULL,
  supports_download boolean NOT NULL,
  maximum_size_bytes bigint NOT NULL,
  security_profile character varying(100) NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.resource_licenses (
  ...
  allows_distribution boolean NOT NULL,
...
CREATE TABLE public.resource_localizations (
  ...
  parent_entity_id uuid NOT NULL,
  language_code character varying(15) NOT NULL,
  localized_title character varying(255) NOT NULL,
  localized_description text NULL,
  localized_change_summary text NULL,
  source_language_code character varying(15) NOT NULL,
  translation_method character varying(50) NOT NULL,
  translation_status character varying(50) NOT NULL,
  status character varying(50) NOT NULL,
...
CREATE TABLE public.resource_metadata_definitions (
  ...
  applies_to_resource_type_id uuid NULL,
  is_required boolean NOT NULL,
...
CREATE TABLE public.resource_preview_objects (
  id uuid NOT NULL,
  resource_preview_id uuid NOT NULL,
  storage_object_id uuid NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
...
CREATE TABLE public.resource_previews (
  id uuid NOT NULL,
  resource_version_id uuid NOT NULL,
  preview_type character varying(50) NOT NULL,
  page_number integer NULL,
  start_time_seconds numeric NULL,
...
CREATE TABLE public.resource_publish_history (
  id uuid NOT NULL,
  learning_resource_id uuid NOT NULL,
  resource_variant_id uuid NOT NULL,
  resource_version_id uuid NOT NULL,
  action character varying(100) NOT NULL,
  from_status character varying(50) NOT NULL,
  to_status character varying(50) NOT NULL,
  publication_number integer NULL,
  validation_snapshot_json jsonb NULL,
  security_snapshot_json jsonb NULL,
  storage_snapshot_json jsonb NULL,
...
CREATE TABLE public.resource_references (
  ...
  provider_resource_id character varying(255) NULL,
  resource_domain character varying(100) NULL,
  resource_uri character varying(500) NULL,
  resource_version_id character varying(100) NULL,
  title_snapshot character varying(255) NULL,
  mime_type_snapshot character varying(100) NULL,
  checksum character varying(100) NULL,
  availability_status character varying(50) NOT NULL,
  is_external boolean NOT NULL,
  external_provider character varying(100) NULL,
  external_url character varying(500) NULL,
  license_code character varying(100) NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version integer NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.resource_security_scan_results (
  ...
  scanner_version character varying(50) NULL,
  scan_status character varying(50) NOT NULL,
  threats_found_json jsonb NOT NULL,
...
CREATE TABLE public.resource_tags (
  ...
  name character varying(255) NOT NULL,
  description text NULL,
  tag_group character varying(100) NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.resource_type_format_rules (
  id uuid NOT NULL,
  resource_type_id uuid NOT NULL,
  resource_format_id uuid NOT NULL,
  is_allowed boolean NOT NULL,
  is_recommended boolean NOT NULL,
  requires_preview boolean NOT NULL,
  requires_security_scan boolean NOT NULL,
  maximum_size_override_bytes bigint NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.resource_types (
  ...
  description text NULL,
  category character varying(100) NOT NULL,
  default_sensitivity character varying(50) NOT NULL,
  requires_preview boolean NOT NULL,
  requires_download boolean NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.resource_validation_results (
  ...
  storage_object_id uuid NULL,
  validation_type character varying(100) NOT NULL,
  validator_name character varying(255) NOT NULL,
  validator_version character varying(50) NULL,
...
CREATE TABLE public.resource_variants (
  ...
  code character varying(100) NOT NULL,
  language_code character varying(15) NOT NULL,
  region_code character varying(10) NULL,
  accessibility_profile character varying(100) NOT NULL,
  variant_purpose character varying(50) NOT NULL,
  is_default boolean NOT NULL,
...
CREATE TABLE public.resource_version_dependencies (
  id uuid NOT NULL,
  resource_version_id uuid NOT NULL,
  dependent_resource_version_id uuid NOT NULL,
  dependency_type character varying(100) NOT NULL,
  is_required boolean NOT NULL,
  minimum_status character varying(50) NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
  lock_version bigint NOT NULL,
  created_at timestamp with time zone NOT NULL,
...
CREATE TABLE public.resource_version_objects (
  ...
  resource_version_id uuid NOT NULL,
  storage_object_id uuid NOT NULL,
  object_role character varying(50) NOT NULL,
  display_order integer NOT NULL,
  is_required boolean NOT NULL,
  status character varying(50) NOT NULL,
  version_no integer NOT NULL,
...
CREATE TABLE public.resource_versions (
  ...
  description text NULL,
  resource_format_id uuid NOT NULL,
  version_label character varying(100) NULL,
  change_summary text NULL,
  source_attribution text NULL,
  copyright_owner character varying(255) NULL,
...
CREATE TABLE public.storage_objects (
  ...
  object_path character varying(500) NOT NULL,
  provider_object_id character varying(500) NULL,
  original_filename character varying(255) NOT NULL,
  detected_mime_type character varying(255) NOT NULL,
  detected_extension character varying(50) NOT NULL,
  size_bytes bigint NOT NULL,
  etag character varying(255) NULL,
  storage_class character varying(50) NOT NULL,
  integrity_status character varying(50) NOT NULL,
  security_status character varying(50) NOT NULL,
  availability_status character varying(50) NOT NULL,
...
CREATE TABLE public.storage_quota_policies (
  ...
  maximum_total_bytes bigint NOT NULL,
  maximum_single_object_bytes bigint NOT NULL,
  maximum_monthly_ingest_bytes bigint NOT NULL,
  warning_threshold_percentage numeric NOT NULL,
...
CREATE TABLE public.upload_sessions (
  ...
  resource_version_id uuid NOT NULL,
  requested_format_id uuid NOT NULL,
  original_filename character varying(255) NOT NULL,
  declared_mime_type character varying(255) NOT NULL,
  declared_size_bytes bigint NOT NULL,
  reserved_bytes bigint NOT NULL,
  target_bucket character varying(100) NOT NULL,
  target_object_path character varying(500) NOT NULL,
...
CREATE TABLE resource_read.resource_broken_link_projection (
  ...
  resource_version_id uuid NOT NULL,
  title character varying(255) NULL,
  broken_url character varying(500) NOT NULL,
  http_status_code integer NULL,
  error_message text NULL,
...
CREATE TABLE resource_read.resource_collection_tree_projection (
  ...
  path_ancestry character varying(500) NOT NULL,
  resource_count integer NOT NULL,
  status character varying(50) NOT NULL);

CREATE TABLE resource_read.resource_duplicate_projection (
  checksum_value character varying(255) NOT NULL,
  storage_object_ids jsonb NOT NULL,
  resource_version_ids jsonb NOT NULL,
...
CREATE TABLE resource_read.resource_search_projection (
  ...
  category_hierarchy_json jsonb NOT NULL,
  is_public_delivery boolean NOT NULL,
  sensitivity character varying(50) NOT NULL);
...
CREATE TABLE resource_read.resource_storage_health_projection (
  ...
  ingested_bytes_30_days bigint NOT NULL,
...
CREATE TABLE resource_read.resource_summary_projection (
  ...
  primary_object_path character varying(500) NULL,
  primary_mime_type character varying(255) NULL,
...
CREATE TABLE resource_read.resource_usage_projection (
  ...
  learning_resource_id uuid NOT NULL,
  resource_version_id uuid NOT NULL,
  consumer_domain character varying(100) NOT NULL,
  consumer_entity_type character varying(100) NOT NULL,
  consumer_entity_id uuid NOT NULL,
  consumer_display_name character varying(255) NULL,
  is_active boolean NOT NULL,
