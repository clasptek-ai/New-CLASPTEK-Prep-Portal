...
async function main() {
  ...
  try {
    ...
    const schemaRes = await client.query(`
      ...
      WHERE table_schema IN ('public', 'curriculum_read', 'resource_read')
      ORDER BY table_schema, table_name, ordinal_position;
    `);

    let backupContent = '-- Clasptek Sprint 2.4 Legacy Database Schema Backup\n\n';
    let currentTable = '';
    ...
    const backupPath = path.resolve(__dirname, 'db_schema_sprint2.4_backup.sql');
