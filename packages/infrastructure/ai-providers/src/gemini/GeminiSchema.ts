...
/**
 * IELTS Writing Evaluation Schema — Gemini structured output validation.
 *
 ...
 */
export const GeminiWritingEvaluationSchema = z.object({
  overallBand: z
    .number()
    .min(0)
    .max(9)
...
export type GeminiWritingEvaluationOutput = z.infer<typeof GeminiWritingEvaluationSchema>;

/**
 * IELTS Speaking Evaluation Schema — Gemini structured output validation.
 *
 ...
 * - Pronunciation
 */
export const GeminiSpeakingEvaluationSchema = z.object({
  overallBand: z
    .number()
    .min(0)
    .max(9)
...
export type GeminiSpeakingEvaluationOutput = z.infer<typeof GeminiSpeakingEvaluationSchema>;

/**
 * Legacy generic evaluation schema — retained for backward compatibility.
 */
