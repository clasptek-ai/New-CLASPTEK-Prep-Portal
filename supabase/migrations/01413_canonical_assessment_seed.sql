...
('a0000000-0000-0000-0000-000000000001', 'ENG-PROF-DIAG', 'English Proficiency', 'English Proficiency Placement Diagnostic', 'DIAGNOSTIC'),
('a0000000-0000-0000-0000-000000000002', 'IELTS-AC-DIAG', 'IELTS Academic', 'IELTS Academic Readiness Diagnostic', 'DIAGNOSTIC'),
('a0000000-0000-0000-0000-000000000003', 'IELTS-GT-DIAG', 'IELTS General Training', 'IELTS General Training Readiness Diagnostic', 'DIAGNOSTIC'),
('a0000000-0000-0000-0000-000000000004', 'TOEFL-IBT-DIAG', 'TOEFL iBT', 'TOEFL iBT Readiness Diagnostic', 'DIAGNOSTIC'),
('a0000000-0000-0000-0000-000000000005', 'SAT-DIGITAL-DIAG', 'SAT', 'Digital SAT Readiness Diagnostic', 'DIAGNOSTIC'),
('a0000000-0000-0000-0000-000000000006', 'CELPIP-GEN-DIAG', 'CELPIP', 'CELPIP General Readiness Diagnostic', 'DIAGNOSTIC')
...
('c0000000-0000-0000-0000-000000000001', 'ENG-PROF-GRAMMAR', 'English Proficiency', 'Grammar & Structure', 1, 10, 'Answer all grammar, tenses, and sentence structure questions.'),
('c0000000-0000-0000-0000-000000000002', 'ENG-PROF-READING', 'English Proficiency', 'Reading Comprehension', 2, 10, 'Read the passage carefully and answer the questions that follow.'),
('c0000000-0000-0000-0000-000000000003', 'ENG-PROF-WRITING', 'English Proficiency', 'Writing Expression', 3, 10, 'Compose a well-structured essay response adhering to prompt requirements.'),
('c0000000-0000-0000-0000-000000000004', 'ENG-PROF-LISTENING', 'English Proficiency', 'Listening Comprehension', 4, 10, 'Listen to the audio track and select the best response for each question.'),
('c0000000-0000-0000-0000-000000000005', 'ENG-PROF-SPEAKING', 'English Proficiency', 'Speaking & Oral Delivery', 5, 10, 'Record or submit your oral response to the cue card prompt.')
ON CONFLICT (code) DO UPDATE SET
  name = EXCLUDED.name,
...
('d0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'INTERMEDIATE', 50.00, 100.00, '{"Grammar": 40.0, "Reading": 40.0}'::jsonb, 2),
('d0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'FOUNDATION', 0.00, 49.99, '{}'::jsonb, 1)
...
('e0000000-0000-0000-0000-000000000001', 'ENG-PROF-AUDIO-1', 'English Proficiency Conversation Audio', 'https://cdn.clasptek.com/audio/eng-prof-diagnostic-track-1.mp3', 180, 'Speaker 1: Welcome to the orientation seminar...', 'English Proficiency', 'published')
ON CONFLICT (code) DO UPDATE SET
  title = EXCLUDED.title,
  url = EXCLUDED.url;
...
('f0000000-0000-0000-0000-000000000002', 'ENG-PROF-TASK-1', 'English Proficiency', 1, 'Education Essay Prompt', 'Discuss whether remote learning is as effective as traditional classroom education.', 'Write a well-structured essay discussing both sides.', 150)
ON CONFLICT (code) DO UPDATE SET
...
('f0000000-0000-0000-0000-000000000003', 'ENG-PROF-CUE-1', 'English Proficiency', 2, 'Memorable Journey Cue Card', 'Describe a memorable journey you have taken. Speak for 1-2 minutes.', 60, 120)
ON CONFLICT (code) DO UPDATE SET
  prompt = EXCLUDED.prompt;
