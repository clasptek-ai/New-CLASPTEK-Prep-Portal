...
async function runProductionBackfill() {
  ...
  try {
    ...
    console.log(
      `1. Reconciled ${res1.rows.length} existing candidate profile records in public.profiles.`
    );
    ...
    console.log(
      `2. Updated ${res2.rows.length} candidate profiles with default target_programme ('English Proficiency').`
    );
