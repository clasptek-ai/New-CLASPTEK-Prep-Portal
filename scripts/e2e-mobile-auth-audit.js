...
async function runMobileAuthAudit() {
  ...
  console.log(
    `- NEXT_PUBLIC_SUPABASE_URL: ${process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://texnwdyeyussmevexscw.supabase.co'}`
  );
  console.log(
    `- NEXT_PUBLIC_SITE_URL: ${process.env.NEXT_PUBLIC_SITE_URL || 'https://portal.clasptek.org'}`
  );
  ...
  const paperSnapshot = {
    ...
    grammarQuestions: [
      {
        ...
        code: 'ENG-GRAM-M01',
        prompt: 'Select the correct option for sentence structure on mobile.',
        options: [
    ...
    readingPassage: {
      id: randomUUID(),
      code: 'READ-MOB-01',
      title: 'Mobile Web Performance in 2026',
    ...
    writingTasks: [
      {
        ...
        taskNumber: 1,
        title: 'Mobile Task',
        prompt: 'Discuss mobile usability.',
        minWords: 100,
        maxWords: 300,
        marks: 10,
      },
