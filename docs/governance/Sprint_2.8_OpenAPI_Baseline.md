...
name: submissionId
schema: { type: string, format: uuid } - in: query
name: status
schema:
type: string
enum: [QUEUED, RUNNING, COMPLETED, FAILED, HUMAN_REVIEW_REQUIRED, APPROVED, PUBLISHED, ARCHIVED] - in: query
name: questionType
schema:
type: string
enum: [OBJECTIVE, ESSAY, WRITING, SPEAKING, CODING, STRUCTURED] - in: query
name: limit
schema: { type: integer, default: 20, maximum: 100 } - in: query
name: offset
...
name: id
required: true
schema: { type: string, format: uuid } - in: header
name: x-student-id
required: true
schema:
type: string
