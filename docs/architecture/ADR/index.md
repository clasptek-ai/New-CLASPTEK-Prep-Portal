...
| **ADR-029** | Readiness & Prediction Engine Quality Enhancements | Student Experience   | Accepted | [ADR-029](./029-readiness-prediction-enhancements.md) |
...
- **diagnostic-placement** (entry diagnostics engine, adaptive placement tests, skill gap profiling, learning path recommendations, and English Foundation assessments)
- **mock-examination** (mock blueprints, templates, sessions, multi-exam scoring, readiness engine)
